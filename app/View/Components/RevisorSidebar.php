...
class RevisorSidebar extends Component
{
    ...
    public function __construct(
        ...
        $this->title = $title ?? 'Panel de Revisor';
        $this->userRole = $userRole ?? 'Revisor Institucional';
    ...
    {
        return view('components.revisor-sidebar');
    }
}