...
{{-- Menú lateral --}}
    <aside class="w-64 bg-blue-100 h-auto p-4 shadow-md">
        <h3 class="text-lg font-bold mb-4">Menú Autoridad</h3>
             <p class="mb-4 font-bold" >Acciones disponibles:</p>
            <ul class="list-disc ml-6 text-blue-700 space-y-2">
                <li><a href="{{ route('autoridad.index') }}"class="block p-2 rounded hover:bg-gray-200">Emitir Aprobación Final del Plan Institucional</a></li>
            </ul>
    </aside>
      {{-- Contenido principal --}}
