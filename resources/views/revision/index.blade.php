...
<div class="container mx-auto p-4">
    ...
    {{-- Eliminamos la columna derecha fija para usar un modal --}}
                            ...
                            <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden border">
                                <thead class="bg-blue-600 text-white">
                                    <tr>
                                        ...
                                        <th class="px-4 py-3 text-center">Detalle</th> {{-- NUEVA COLUMNA --}}
            ...
            <div class="space-y-8">
                ...
                <div class="grid md:grid-cols-4 gap-4 p-4 bg-blue-50 rounded-xl border border-blue-200">
                    ...
                    <div class="flex flex-col">
                        <p class="text-xs font-semibold uppercase text-blue-600">Estado Revisión</p>
                        <span class="font-extrabold text-lg px-2 py-0.5 rounded-full inline-block mt-1 self-start ${
                            estadoRevision === 'Aprobado' ? 'text-green-700 bg-green-100' : 
                            (estadoRevision === 'Devuelto' ? 'text-red-700 bg-red-100' : 'text-yellow-700 bg-yellow-100')
                        }">${estadoRevision}</span>
                    </div>
                </div>
                {{-- 2. Datos Generales --}}
